package com.oraclechain.pe4devs.view.dialog.passworddialog;
...
public class PasswordDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (KeyBoardUtil.isSoftInputShow((Activity) context)) {
            KeyBoardUtil.getInstance((Activity) context).hide();
        }
        switch (v.getId()) {
